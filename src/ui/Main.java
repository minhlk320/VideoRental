...
public class Main extends Application {
    ...
    public final String SCENE_RETURN_ITEMS = "ReturnItems";
    public final String URL_RETURN_ITEMS = "/resources/fxml/ReturnItem.fxml";
    public final Image MAIN_ICON = new Image("/resources/img/icon.png");
    ...
    public void initLayout() {
        ...
        listUI.put(SCENE_RETURN_ITEMS, URL_RETURN_ITEMS);
    }
